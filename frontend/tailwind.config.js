  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neumorphic-inset': 'inset 20px 20px 60px #1a1a1a, inset -20px -20px 60px #262626',
        'input': '0 2px 4px rgb(0 0 0 / 0.1) inset',
        'card-hover': '0 0 0 2px rgba(255, 255, 255, 0.1), 0 30px 60px -12px rgba(50, 50, 93, 0.25), 0 18px 36px -18px rgba(0, 0, 0, 0.3)',
      },
      backgroundImage: {
